...
public class Proto extends javax.swing.JFrame {
    ...
    public void validar(){
        ...
        if(!"".equals(correo_usuario)|| !"".equals(contraseña_usuario)){
            
            lg= login.log(correo_usuario,contraseña_usuario);
            if(lg.getCorreo_usuario()!=null && lg.getContraseña_usuario()!=null){
                Protoa poa=new Protoa(lg);
                poa.setVisible(true);
                dispose();
                
            }else{
                JOptionPane.showMessageDialog(null,"Correo o contraseñoa incorrecto");
            }
